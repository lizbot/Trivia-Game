...
namespace LinqToWikiBot
{
    ...
    class SearchWord_Description
    {
        ...
        internal void Write_Console()
        {
            ...
            domaininfo.ConfigurationFile = System.Environment.CurrentDirectory + "SearchWord_Description.exe.config";
            ...
            using (StreamWriter outfile = new StreamWriter(@"C:\Users\JorgeJ\Documents\GitHub\Trivia-Game\TriviaGame\bin\wiki_" + subject_print[1] + "_" + category_subject + ".xml"))
            {
